[![GoDoc](https://godoc.org/github.com/RadicalApp/goquery?status.png)](https://godoc.org/github.com/haoyayun/libsignal-protocol-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/haoyayun/libsignal-protocol-go)](https://goreportcard.com/report/github.com/haoyayun/libsignal-protocol-go)
...
- [API Reference](https://godoc.org/github.com/haoyayun/libsignal-protocol-go)
...
Install the Signal library using the "go get" command:
    ...
    go get github.com/haoyayun/libsignal-protocol-go/...
...
```go
import "github.com/haoyayun/libsignal-protocol-go/serializer"
